...
--------------------------------
Arguments passed into subroutines are located in @_ as separate elements in the order they are written

shift removes and returns values from the beginning of an array
the default is the @_
=end comment
